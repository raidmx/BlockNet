...
use bytes::Bytes;
use glam::Vec3;
use binary::{Decode, Encode, Reader, VarI32, VarU32, VarU64, Writer};
...
impl<'a> Decode<'a> for PlayerInventoryAction<'a> {
    fn decode(r: &mut Reader<'a>) -> Option<Self> {
        let legacy_request_id = VarI32::decode(r)?;
